		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Example Master-Detail App with Northwind Data",
									"targetURL": "#ExampleMasterDetailAppwithNorthwindData-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ExampleMasterDetailAppwithNorthwindData-display": {
								"semanticObject": "ExampleMasterDetailAppwithNorthwindData",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Northwind.SampleMaster-DetailApp",
									"url": sap.ui.require.toUrl("Northwind/SampleMaster-DetailApp")
								}
							}
						}
					}
